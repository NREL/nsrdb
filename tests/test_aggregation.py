...
FP_OUT = os.path.join(TESTDATADIR, TESTJOB1['final']['data_sub_dir'],
                      TESTJOB1['final']['fout'].replace('.h5', '_0.h5'))
...
def test_spatial_agg():
    ...
    Manager.run_chunk(TESTJOB1, TESTDATADIR, meta_dir, 0, 1,
...
def test_spatiotemporal_agg():
    ...
    Manager.run_chunk(TESTJOB2, TESTDATADIR, meta_dir, 0, 1,
                      year=2018, parallel=False, log_level=False,
                      ignore_dsets=IGNORE_DSETS)
